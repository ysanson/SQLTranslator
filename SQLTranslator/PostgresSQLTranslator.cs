...
{
    class PostgresSQLTranslator
    {
        public static List<string> GenerateTable(List<string> inputBloc)
        {
        ...
        private static string RemoveDefaultValueForNumericTypes(string line)
        {
        ...
        private static string RemoveDefaultValueForCharacterTypes(string line)
        {
        ...
        public static string GenerateInsert(string inputLine)
        {
        ...
        public static string GenerateDrop(string inputLine)
        {
